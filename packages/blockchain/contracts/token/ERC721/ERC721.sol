...
// Tweaked version to be compatible with ERC721napshot
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function transferFrom(
        ...
        require(
            ...
            "ERC721: transfer caller is note owner nor approved"
        );
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        ...
        TokenTransfer memory newTransfer = createTokenTransfer(_msgSender(), address(0), to, tokenId, "");
    ...
    function _burn(uint256 tokenId) internal virtual {
        ...
        TokenTransfer memory newTransfer = createTokenTransfer(_msgSender(), owner, address(0), tokenId, "");
    ...
    function _transfer(
        ...
        TokenTransfer memory newTransfer = createTokenTransfer(_msgSender(), from, to, tokenId, "");
